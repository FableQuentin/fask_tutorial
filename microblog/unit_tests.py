# run '(venv) python tests.py' to run this unitary test
import os

# To prevent using the actual database, we change the application configuration 
...
class UserModelCase(unittest.TestCase):
    ...
    # setUp: creates an application context and pushes it.
    # This ensures that the Flask application instance, along with its configuration data is accessible to Flask extensions.
    def setUp(self):
        self.app_context = app.app_context()
        self.app_context.push()
        db.create_all() # create the database tables from scratch
    ...
    def test_avatar(self):
        ...
        self.assertEqual(user.get_avatar_url(128), ('https://www.gravatar.com/avatar/'
    ...
    # test following posts functionality 
